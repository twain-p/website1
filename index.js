...
http.createServer(function (req, res) {
    ...
    if (req.method = 'GET') {
        ...
        else if (req.url.substring(0, 18) == "/sainsburystrailer") {
            webpages.SainsburysTrailer(req, res);
        }
        else if (req.url.substring(0, 16) == "/waitrosetrailer") {
            webpages.waitroseTrailer(req, res);
        }
        else {
