...
exports.TescoTrailer = function (req, res) {
    ...
    res.setHeader('Content-disposition', 'attachment; filename=trailer_by_josh.scs');
...
exports.SainsburysTrailer = function (req, res) {
    var file = __dirname + '/assets/sainsburystrailer.scs';
...
exports.waitroseTrailer = function (req, res) {
    var file = __dirname + '/assets/waitrosetrailer.scs';
